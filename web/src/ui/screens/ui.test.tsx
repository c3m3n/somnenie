...
function moduleFixture(id = "M01"): CourseModule {
  return { id, title: "Тема", phaseId: "phase1", phaseTitle: "Фаза 1", files: { "theory.md": "# Theory", "terms.md": "Terms", "practice.md": "Practice", "diagrams.md": "Diagrams", "summary.md": "Summary", "quiz.md": quizMarkdown() } };
}
