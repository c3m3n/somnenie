(function (root, factory) {
  ...
  function upsertWrongQuestion(review, payload, now = new Date()) {
    ...
    const item = {
      ...
      reviewStrategy: payload.reviewStrategy || previous.reviewStrategy || "Задать новый вопрос в том же формате рассуждения.",
      repair,
  ...
  function itemFromWeakSpot(moduleId, spot, now = new Date()) {
    ...
    return normalizeReviewItem({
      ...
      reviewStrategy: spot?.reviewStrategy || "Задать новый вопрос в том же формате рассуждения.",
